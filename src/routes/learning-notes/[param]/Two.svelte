...
<p>
    <a class="ext" href="https://kit.svelte.dev/docs/routing">routing</a>:
    ...
    <a class="ext" href="https://svelte.dev/blog/zero-config-type-safety">(more info on types)</a>.&nbsp;
</p>
<p>
...
<p>
    <a class="ext" href="https://kit.svelte.dev/docs/state-management">state management</a>:
    not done yet
</p>